...
// --- UI Elements ---
let solarInput, batteryInput, fanCheck, tvCheck, acCheck, waterHeater, resultDisplay, starRatingDisplay;
...
function updateSimulation() {
    ...
    const dailySolarGeneration = solarCount * 0.4 * 4; // (panels * kW/panel * hours)
    ...
    if (dailyEnergyDemand === 0) {
        ...
        const surplusKwhPerDay = -netDailyDemand;
